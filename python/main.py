...
device_list_header = """#ifndef __ETHERCAT_DEVICE_INFO_LIST_H
...
device_list_footer = """#endif /* __ETHERCAT_DEVICE_INFO_LIST_H */"""
...
def generate_device_list(devices):
    output_lines = []
...
def test_header(_hdr, _dev):
    ...
    with open("./ethercat_device_info.h", "w+") as h_file:
        h_file.writelines(_hdr)
    # Create the Device List Header file
    with open("./ethercat_device_list.h", "w+") as h_file:
